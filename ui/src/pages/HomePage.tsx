...
const HomePage = () => {
    return (
        <div className="d-flex flex-column m-5 gap-5 align-items-center">
            <h2 className="fw-bold text-primary text-center">Smart Climate Control</h2>
            <div className="w-50">
            ...
            <div className="d-flex flex-wrap align-items-center w-100 justify-content-around">
                <div className="d-flex flex-column gap-5 w-50 hover-class">
                    <h2 className="fw-bold text-primary text-center">Sensors in your house?</h2>
                    <p className="fw-bold text-center fs-4">Smart Climate Control empowers you with a comprehensive sensor network strategically placed in each room of your house.
            ...
            <div className="d-flex flex-wrap align-items-center w-100 justify-content-around">
                ...
                <div className="d-flex flex-column gap-5 w-50 hover-class">
                    <h2 className="fw-bold text-primary text-center">Check the room situation!</h2>
                    <p className="fw-bold text-center fs-4">Curious about the current climate in a specific room?
            ...
            <div className="d-flex flex-wrap align-items-center w-100 justify-content-around">
                <div className="d-flex flex-column gap-5 w-50 hover-class">
                    <h2 className="fw-bold text-primary text-center">Add room to application!</h2>
                    <p className="fw-bold text-center fs-4">Customize Smart Climate Control to match the unique layout of your home by easily adding rooms to the application.
            ...
            <div className="d-flex flex-wrap align-items-center w-100 justify-content-around">
                ...
                <div className="d-flex flex-column gap-5 w-50 hover-class">
                    <h2 className="fw-bold text-primary text-center">Receive alerts!</h2>
                    <p className="fw-bold text-center fs-4">Stay connected and informed with Smart Climate Control's alert system.
